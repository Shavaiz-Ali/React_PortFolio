import {ProjectsDataRight} from "./ProjectsData";
import { BsArrowBarRight } from "react-icons/bs";
import {Link} from "react-router-dom";
export const ProjectRight = () =>{
    return(
        <>
            <div className="projects mx-auto sm:grid grid-cols-12 gap-5 ">
            {
                ProjectsDataRight.map((item) =>{
                    return(
                        <>                        
                        <div className="flex flex-col justify-center bg-[#161616] rounded-[20px] p-6 col-span-6 sm:mt-0 mt-4 ">
